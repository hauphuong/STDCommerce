using STD.Core.ComponentModel;
using STD.Core.Domain.Shipping;
using System;
...
namespace STD.Core
{
    ...
    public partial class CommonHelper
    {
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new STDException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new STDException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new STDException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
